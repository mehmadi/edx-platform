...
CertData = namedtuple("CertData", ["cert_status", "title", "msg", "download_url",
                                   "cert_web_view_url", "past_availability_date"])
...
def _get_cert_data(student, course, course_key, is_active, enrollment_mode):
    ...
    past_availability_date = course_key and get_course_by_id(course_key).may_certify()
        ...
        if certs_api.has_html_certificates_enabled(course_key, course):
            if certs_api.get_active_web_certificate(course) is not None:
                ...
                return CertData(cert_status,
                                ...
                                past_availability_date=past_availability_date)
            else:
                return CertData(
